...
Whisper is available in the Hugging Face [Transformers](https://github.com/huggingface/transformers) library from Version 4.23.1, with both PyTorch and TensorFlow implementations. All the official checkpoints can be found on the [Hugging Face Hub](https://huggingface.co/models?search=openai/whisper), alongside [documentation](https://huggingface.co/docs/transformers/model_doc/whisper) and [examples scripts](https://huggingface.co/blog/fine-tune-whisper).
