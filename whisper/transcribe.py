...
def cli():
    ...
    parser.add_argument("--max_words_count", type=optional_int, default=None, help="(requires --word_timestamps True) (no effect with --max_line_width) the maximum number of words in a segment")
